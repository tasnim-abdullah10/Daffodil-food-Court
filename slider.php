	 <div id="jssor_1"
	     ...
	     <div data-u="slides"
	         ...
	         <div data-p="225.00">
	             <img data-u="image" src="img/greengarden.jpg" />
	             <div
	                 style="position:absolute;top:100px;left:30px;width:1000px;height:1000px;z-index:0;font-size:50px;color:#ffffff;line-height:60px;">
	             </div>
